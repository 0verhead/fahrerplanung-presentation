...
/**
 * Internal shadow representation (normalized)
 */
export type InternalShadow = {
...
/**
 * Internal glow representation (normalized)
 */
export type InternalGlow = {
  size: number;
  color: HexColor;
  opacity: number;
} | null;
...
// ============================================
// ORIGINAL TYPES (with extensions)
// ============================================
...
/**
 * Normalize shadow props to internal format
 */
export const normalizeShadow = (shadow: ShadowProps | undefined): InternalShadow => {
...
/**
 * Normalize glow props to internal format
 */
...
const normalizeTextType = (
  ...
  return {
    ...
    style: {
      ...
      // EXTENDED: shadow and rotate for text
      shadow: normalizeShadow(style?.shadow),
      rotate: style?.rotate,
    },
  };
};
  ...
  if (isLine(node)) {
    return {
      ...
      style: {
        ...
        // EXTENDED: dash type
        dashType: node.props.style.dashType,
      },
    };
  }
    ...
    return {
      ...
      style: {
        ...
        backgroundColor: style.backgroundColor
          ? normalizeHexOrComplexColor(style.backgroundColor)
          : null,
        borderColor: style.borderColor
          ? normalizeHexColor(style.borderColor)
          : null,
        borderWidth: style.borderWidth ?? null,
        // EXTENDED: shadow, glow, rotate, rectRadius, borderDash, flip
        shadow: normalizeShadow(style.shadow),
        glow: normalizeGlow(style.glow),
        rotate: style.rotate,
