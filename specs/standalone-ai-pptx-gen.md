...
- [ ] **Project scaffolding** — Initialize Electron + React app under `app/` using `electron-vite@5.0.0`. Set up with Electron 40, Vite 7, React 19, TypeScript 5.9. Configure monorepo workspaces to include `packages/react-pptx-extended`.
